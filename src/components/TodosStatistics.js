      ...
      <Row className="todosStatistics">
        <Col sm={12}>
          ...
          >
            ...
            <span className="todosStatistics__statusDone todosStatistics__statusDone--quantity p-2">
        ...
        <Col sm={12}>
          ...
          >
            ...
            <span className="todosStatistics__statusInprogress todosStatistics__statusInprogress--quantity p-2">
        ...
        <Col sm={12}>
          ...
          >
            ...
            <span className="todosStatistics__statusTodo todosStatistics__statusTodo--quantity p-2">
