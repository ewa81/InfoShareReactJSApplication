  ...
  render() {
    ...
    return (
      <li className="todos__item">
        ...
        {this.props.deleteMode ? <Form.Check type="checkbox" className="todos__checkbox mt-2 mb-2" label="Check todo to delete" onClick={() => this.props.selectTheTodoToBeRemoved(this.props.index)}/> : null}
      </li>
    );
  }
