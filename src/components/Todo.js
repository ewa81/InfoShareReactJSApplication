  ...
  render() {
    ...
    return (
      <li className="todos__item">
        ...
        <FontAwesomeIcon icon={faTrash} className="todos__icon todos__icon--delete" onClick={() => this.removeTodo2(this.props.todo._id)}/>
      </li>
    );
  }

  removeTodo2 = (id) => {
    const result = this.props.todos.find(item => item._id === id);
